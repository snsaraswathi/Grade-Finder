...
$check=mysqli_query("SELECT * FROM Login WHERE `EmailId`='$EA'");
...
if(mysql_num_rows($check)>=1){
	...
	$body="Hello $username,\n\n Please click on the given link to activate your account.\n\nhttp://snsaraswathi.com/Grade-Finder/235_project/activate.php?code=$code\n\nThanks.";
	if(!mail($to,$subject,$body,$headers)){
		...
		$register=mysql_query("INSERT INTO Login(`FirstName`,`LastName`,`EmailId`,`Password`,`code`,`active`)
					VALUES('$FN','$LN','$EA','$PW','$code','0')") or die(mysqli_error());
		?><script type="text/javascript">
